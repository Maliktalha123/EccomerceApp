...
import { HeartOutlined, HeartFilled, ShoppingCartOutlined, ShareAltOutlined, HomeOutlined } from "@ant-design/icons"
  ...
  const tabItems = [
    {
      ...
      children: (
        <div>
          <Paragraph style={{ fontSize: "16px", lineHeight: "1.6" }}>{product.desc}</Paragraph>
          <Divider />
      ...
      children: (
        <div>
          <div style={{ marginBottom: "16px" }}>
            ...
            <Text style={{ marginLeft: "8px" }}>4.5 out of 5 (128 reviews)</Text>
          </div>
          <Card size="small" style={{ marginBottom: "12px" }}>
            <div>
              <Text strong>John D.</Text>
              <Rate disabled defaultValue={5} style={{ fontSize: "12px", marginLeft: "8px" }} />
            </div>
          ...
          <Card size="small">
            <div>
              ...
              <Rate disabled defaultValue={4} style={{ fontSize: "12px", marginLeft: "8px" }} />
            </div>
    ...
    <div style={{ backgroundColor: "#f5f5f5", minHeight: "100vh" }}>
      <div className="container mx-auto" style={{ padding: "24px" }}>
        ...
        <Card style={{ borderRadius: "12px", overflow: "hidden" }}>
              ...
              <div style={{ padding: "0 16px" }}>
                ...
                <div style={{ marginBottom: "24px" }}>
                  <Row gutter={[16, 16]}>
                    <Col xs={24} sm={12}>
                      ...
                      <Select value={selectedColor} onChange={setSelectedColor} style={{ width: "100%" }} size="large">
                    ...
                    <Col xs={24} sm={12}>
                      ...
                      <Select value={selectedSize} onChange={setSelectedSize} style={{ width: "100%" }} size="large">
                ...
                <Space size="middle" style={{ width: "100%", marginBottom: "24px" }}>
                  ...
                  <Tooltip title="Share product">
                    <Button size="large" icon={<ShareAltOutlined />} style={{ height: "48px", borderRadius: "6px" }} />
                  </Tooltip>
                </Space>

                {/* Product Features */}
                <Card size="small" style={{ backgroundColor: "#f9f9f9", marginBottom: "24px" }}>
                  <Row gutter={[16, 8]}>
                    <Col span={12}>
          ...
          {/* Product Tabs */}
          <div style={{ padding: "0 16px" }}>
            <Tabs defaultActiveKey="1" items={tabItems} size="large" style={{ minHeight: "200px" }} />
          </div>
        </Card>
      </div>
